...
class ArduinoSerial:
    ...
    def start_read_serial(self):
        """Start to read data from the Arduino DL serial port."""
    ...
    def end_read_serial(self):
        """End to read data from the Arduino DL serial port."""
        self.ser.close()
        print("[INFO] Ended serial port", port)
...
if __name__=="__main__":
    ...
    dl = ArduinoSerial(port, amount, columns_to_plot, unit)
    dl.run()
