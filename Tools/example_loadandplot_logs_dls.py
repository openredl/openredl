...
if __name__ == "__main__":
    ...
    dir_path = "/home/aj/Nextcloud/Laptop/PPRE_Laptop/2024 Summer/Master_Thesis_DL/Gokul/outdoor_reading_1_20240917/dl_inverter"
    file_extention = ".TXT"
    file_marker = "M"
    ...
    # Date filter
    t_start = "2024/09/13 00:00:00"
    #t_end = "2024/09/20 05:30:00"
    t_end = "2024/09/14 00:00:00"
    ...
    # Resampling
    df_rs1min = df.resample('1min').mean()
    ...
    for i in range(len(cols_toplot)):
        ...
        x = df_rs1min.index
        y = df_rs1min[cols_toplot[i]]
        axes[axnum].step(x, y, marker = mk, markersize = mk_sz, 
                         where = 'post',
                         linewidth = lw,
                         label = cols_toplot[i] + "_1min",
                         )
