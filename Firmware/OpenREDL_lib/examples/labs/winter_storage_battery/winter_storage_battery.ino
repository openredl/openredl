...
#define FIRMWARE_DESCRIPTION "Continuous sampling of 4 differential channels, "\
                             "storing at 2 seconds interval."
...
diff2.gain = ADS1115_PGA_4P096;
diff3.gain = ADS1115_PGA_4P096;
diff4.gain = ADS1115_PGA_4P096;
